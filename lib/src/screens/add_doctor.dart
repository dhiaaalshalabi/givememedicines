...
class _AddDoctorPage extends State<AddDoctorPage> {
  ...
  Future<int> insertDoctor(AppDatabase db, Doctor doctor) async {
    return await database.doctorDao.insertDoctor(doctor);
  }
      ...
      if (value == ConnectivityResult.mobile ||
        ...
        DoctorApi.postDoctor(toJson).then((response) {
          if (response.statusCode == 200 || response.statusCode == 201) {
            ...
            insertDoctor(database, Doctor.fromJson(mapData)).then((value) {
              if (value > 0) {
        ...
        doctor.tagged = false;
        insertDoctor(database, doctor).then((value) {
          if (value > 0) {
            showAlertDialog(
